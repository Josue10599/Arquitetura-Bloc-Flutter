import 'package:arquitetura_bloc/src/blocs/movie_detail_bloc.dart';
...
class _MovieDetailState extends State<MovieDetail> {
    ...
    return Scaffold(
      body: SafeArea(
          ...
          child: NestedScrollView(
            headerSliverBuilder: (BuildContext context, bool boxDeslizada) {
              return <Widget>[
                SliverAppBar(
  ...
  _noTrailer(TrailerModel data) => Center(
        child: Container(
          child: Text('Nenhum Trailer Localizado'),
        ),
      );

  _trailerLayout(TrailerModel data) {
  ...
  _trailerItem(TrailerModel data, int index) => Expanded(
        child: Column(
          children: <Widget>[
            Container(
